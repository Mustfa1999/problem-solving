...
const applicationsStatics = (arr) => {
    ...
    for (let i = 0; i < arrLangth; i++) {
        ...
        switch(arr[i].tech){
            case "Python": result["python_Devs"] = result["python_Devs"] + 1 ; break;
            case "JS": result["javaScript_Devs"] = result["javaScript_Devs"] + 1 ; break;
            case ".Net": result["dotNet_Devs"] = result["dotNet_Devs"] + 1 ; break;
            case "Java": result["java_Devs"] = result["java_Devs"] + 1 ; break;
        };
